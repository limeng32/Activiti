...
import org.activiti.engine.impl.cmd.JumpActivityCmd;
...
import org.activiti.engine.impl.cmd.WithdrawTaskCmd;
...
public class TaskServiceImpl extends ServiceImpl implements TaskService {
	...
	@Override
	public void jump(String _taskId, String _toTaskKey, Map _variables) {
		commandExecutor.execute(new JumpActivityCmd(_taskId, _toTaskKey, _variables));
	}

	@Override
	public void withdraw(String _taskId, String _toTaskId, Map _variables) {
		commandExecutor.execute(new WithdrawTaskCmd(_taskId, _toTaskId, _variables));
	}
