...
public class MySmartDataSource extends DriverManagerDataSource implements SmartDataSource, DisposableBean {
	 ...
	 */
	public MySmartDataSource(String url, String username, String password, boolean suppressClose) {
	 ...
	 * @see java.sql.DriverManager#getConnection(String, String, String)
	 */
	public MySmartDataSource(String url, boolean suppressClose) {
		super(url);
		this.suppressClose = suppressClose;
	}
	 ...
	 *            suppresses {@code close()} calls (to allow for normal
	 *            {@code close()} usage in applications that expect a pooled
	 *            Connection but do not know our SmartDataSource interface)
	 */
	public MySmartDataSource(Connection target, boolean suppressClose) {
	...
	/**
	 * Set whether the returned Connection's "autoCommit" setting should be
	 * overridden.
	 */
	...
	/**
	 * Return whether the returned Connection's "autoCommit" setting should be
	 * overridden.
	 * 
	...
	public Connection getConnection() throws SQLException {
		synchronized (this.connectionMonitor) {
			...
			if (this.connection.isClosed()) {
				System.out.println("Connection was closed in SingleConnectionDataSource. Check that user code checks "
	 ...
	 * username and password; throws a SQLException else.
	 */
	@Override
